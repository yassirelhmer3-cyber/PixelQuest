...
client.on('messageCreate', async (message) => {
    ...
    // ==========================================
    // 👑 2. أوامر الإدارة والأونر (Admin Commands)
    // ==========================================

    // 👑 قائمة أوامر الأونر والأدمن (!adminhelp)
    ...
    // 👑 أمر تحديد المستوى مباشرة (!setlevel)
    if (command === 'setlevel') {
        if (!message.member.permissions.has(PermissionFlagsBits.Administrator)) return message.reply('❌ مخصص للأونرز والإدارة فقط!');
